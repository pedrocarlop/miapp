/*
 BEGINNER NOTES (AUTO):
 - Archivo: Packages/AppModules/Sources/DesignSystem/Theme/ThemeShadows.swift
 ...
 - Tipos clave en este archivo: ThemeShadows
...
public enum ThemeShadows {
    public static let cardAmbient = ShadowTokens.cardAmbient
    public static let cardDrop = ShadowTokens.cardDrop
}
