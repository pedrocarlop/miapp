/*
 BEGINNER NOTES (AUTO):
 - Archivo: Packages/AppModules/Sources/DesignSystem/Components/Layout/WordSearchBoardStylePreset.swift
 ...
 - Tipos clave en este archivo: WordSearchBoardStylePreset
