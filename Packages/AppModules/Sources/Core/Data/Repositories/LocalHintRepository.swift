/*
 BEGINNER NOTES (AUTO):
 - Archivo: Packages/AppModules/Sources/Core/Data/Repositories/LocalHintRepository.swift
 ...
 - Tipos clave en este archivo: LocalHintRepository
 - Funciones clave en este archivo: state,spendHint rewardCompletion,wasRewarded load,persist
